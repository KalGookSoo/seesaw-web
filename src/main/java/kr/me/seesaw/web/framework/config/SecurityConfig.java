...
import kr.me.seesaw.web.framework.security.SeesawPermissionEvaluator;
import kr.me.seesaw.api.framework.security.JwtTokenProvider;
import kr.me.seesaw.web.framework.security.JwtIssuingAuthenticationSuccessHandler;
import kr.me.seesaw.api.domain.service.RoleService;
...
import kr.me.seesaw.web.framework.service.PrincipalOauth2UserService;
...
public class SecurityConfig {
    ...
    @Bean
    public SavedRequestAwareAuthenticationSuccessHandler authenticationSuccessHandler(JwtTokenProvider jwtTokenProvider) {
        return new JwtIssuingAuthenticationSuccessHandler(jwtTokenProvider);
    }

    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, SavedRequestAwareAuthenticationSuccessHandler authenticationSuccessHandler) throws Exception {
        ...
        http.oauth2Login(config -> handleOauth2Login(config, authenticationSuccessHandler));
    ...
    private void handleOauth2Login(
            OAuth2LoginConfigurer<HttpSecurity> httpSecurityOAuth2LoginConfigurer,
